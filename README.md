...
To further enhance accessibility, a lightweight AI assistant was developed using Python and Streamlit. The assistant enables users to ask predefined analytical questions and instantly retrieve insights from the underlying database.
